...
interface ApiService {
    ...
    suspend fun getProductsBySupermarket(@Path("name") supermarket: String): Response<List<Product>>
    ...
    suspend fun getShoppingListsByUser(@Path("userId") userId: String): Response<List<ShoppingList>>
